...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 投诉管理 <span class="c-gray en">&gt;</span> 商品投诉列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
    <table class="table table-border table-bordered table-bg display" id="idleTable">
        <thead>
        <tr>
            <th scope="col" colspan="15">商品投诉列表</th>
        </tr>
        <tr class="text-c">
            <th width="90">举报商品</th>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        idleTable=$("#idleTable").DataTable({
            ajax:{
                url: APP.WEB_APP_NAME+'/complain/listIdle'
            },
            "serverSide": true,
            "destroy": true,
            "pageLength": 10,
