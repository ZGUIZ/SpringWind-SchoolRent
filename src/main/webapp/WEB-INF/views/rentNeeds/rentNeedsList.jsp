...
--%>
    <table class="table table-border table-bordered table-bg display" id="idleTable">
        <thead>
        <tr>
            <th scope="col" colspan="15">帖子列表</th>
        </tr>
        <tr class="text-c">
<%--
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        idleTable=$("#idleTable").DataTable({
            ajax:{
                url: APP.WEB_APP_NAME+'/rentNeeds/queryListByPage'
            },
            "serverSide": true,
            "destroy": true,
            "pageLength": 10,
    ...
    */
    ...
    function unShow(infoId){
        layer.confirm('确认要禁止显示该商品吗？',function(index){
            AjaxUtil.ajax( APP.WEB_APP_NAME+'/rentNeeds/delByManager/'+infoId,'get',true,null,function (data) {
                if(data.result){
